...
enum {
  ...
  CARRICK_COLUMN_IPV6_METHOD,
  CARRICK_COLUMN_IPV6_ADDRESS,
  CARRICK_COLUMN_IPV6_PREFIX_LENGTH,
  CARRICK_COLUMN_IPV6_GATEWAY,
  CARRICK_COLUMN_CONFIGURED_IPV6_METHOD,
  CARRICK_COLUMN_CONFIGURED_IPV6_ADDRESS,
  CARRICK_COLUMN_CONFIGURED_IPV6_PREFIX_LENGTH,
  CARRICK_COLUMN_CONFIGURED_IPV6_GATEWAY,
  CARRICK_COLUMN_NAMESERVERS,
  CARRICK_COLUMN_CONFIGURED_NAMESERVERS,
  CARRICK_COLUMN_IMMUTABLE,
  CARRICK_COLUMN_LOGIN_REQUIRED,
  CARRICK_COLUMN_ETHERNET_MAC_ADDRESS,
};
